...
public class CartDetailsTest {
    ...
    public void getCartDetailsTestWithParamsOKAndItemsInCart() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/VinylStore/api/cart/customer/detail").header("Authorization", auth)).andDo(print()).andExpect(status().isOk());
    ...
    public void getCartDetailsTestWithParamsOKAndNoItemsInCart() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/VinylStore/api/cart/customer/detail").header("Authorization", auth)).andDo(print()).andExpect(status().isNotFound());
