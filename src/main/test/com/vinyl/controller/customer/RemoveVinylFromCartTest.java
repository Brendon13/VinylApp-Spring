...
public class RemoveVinylFromCartTest {
    ...
    public void removeVinylFromCartTestWithPathVariablesOK() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/VinylStore/api/users/cart/{item_id}", "111", "1").header("Authorization", auth)).andDo(print()).andExpect(status().isOk());
    ...
    public void removeVinylFromCartTestWithEmptyCart() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/VinylStore/api/users/cart/{item_id}", "1").header("Authorization", auth)).andDo(print()).andExpect(status().isForbidden());
