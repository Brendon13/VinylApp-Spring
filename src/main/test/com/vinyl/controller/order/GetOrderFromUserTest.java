package com.vinyl.controller.order;
...
import com.vinyl.controller.OrderController;
...
public class GetOrderFromUserTest {
    ...
    public void getOrderFromUserTestWithParamsOK() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/VinylStore/api/orders/{user_id}", "111").header("Authorization", auth)).andDo(print()).andExpect(status().isOk());
    ...
    public void getOrderFromUserTestWithNotExistingUserId() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/VinylStore/api/orders/{user_id}", "111").header("Authorization", auth)).andDo(print()).andExpect(status().isBadRequest());
    ...
    public void getOrderFromUserTestWithParamsOkButNotManager() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/VinylStore/api/orders/{user_id}", "111").header("Authorization", auth)).andDo(print()).andExpect(status().isForbidden());
