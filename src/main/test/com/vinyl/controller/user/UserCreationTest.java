...
public class UserCreationTest {
    ...
    public void customerCreationTestWitEmailAddressAlreadyUsed() throws Exception{
        ...
        registerCustomer("Ion", "Ionescu", "customer.user@gmail.com", "123456").andExpect(status().is4xxClientError()).andDo(print());
    }

    @Test
    public void customerCreationTestWithNoPassword() throws Exception{
        registerCustomer("Ion", "Ionescu", "ion.ionescu@gmail.com", "").andExpect(status().is4xxClientError()).andDo(print());
    }
    ...
    public void managerCreationTestWitEmailAddressAlreadyUsed() throws Exception{
        ...
        registerManager("Ion", "Ionescu", "store.manager@gmail.com", "123456").andExpect(status().is4xxClientError()).andDo(print());
    }
